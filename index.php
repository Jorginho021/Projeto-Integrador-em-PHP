<?php
// Importar as classes da pasta classes
require_once "classes/Cliente.php";
require_once "classes/Produto.php";
require_once "classes/Pedido.php";

// Criar 1 cliente
$cliente = new Cliente(1, "Jorge", "jorge@email.com");

// Criar 5 produtos
$produto1 = new Produto(1, "Notebook", 3500.00);
$produto2 = new Produto(2, "Mouse Gamer", 150.00);
$produto3 = new Produto(3, "Headset", 280.00);
$produto4 = new Produto(4, "Teclado Gamer", 200.00);
$produto5 = new Produto(5, "Mouse Pad", 35.00);
